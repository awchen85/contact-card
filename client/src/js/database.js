...
export const initdb = async () => {
    ...
    export const postDb = async (name, email, phone, profile) => {
        ...
        //Create a connection to the DB and specify version we want to use
        const contactDb = await openDB('contact_db', 1);
        ...
        // const contactDb = await openDB('chicken_db', 1.0);
        // const tx = contactDb.transaction('chicken', readonly);
        // const store = tx.objectStore('chicken');
        // const request = store.getAll();
        // const result = await request;
